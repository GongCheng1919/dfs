...
python ../src/train.py \
 ...
 --model-name resnet18 --model-desc DSN --num-tasks 4 \
 --resume 0 --latest-checkpoint ../models/resnet18-DSN-on-cifar100/save_models/latest-training-state-dict.pth.tar \
